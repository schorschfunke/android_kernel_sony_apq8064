...
CFLAGS_KERNEL	= -mtune=cortex-a15 -mfpu=neon-vfpv4 -mfloat-abi=hard -funsafe-math-optimizations -ftree-vectorize  
AFLAGS_KERNEL	= -mtune=cortex-a15 -mfpu=neon-vfpv4 -mfloat-abi=hard -funsafe-math-optimizations -ftree-vectorize  

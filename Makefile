...
CFLAGS_KERNEL	= -mtune=cortex-a15 -march=armv7-a -marm -mfpu=neon -funsafe-math-optimizations -ftree-vectorize -funroll-loops
AFLAGS_KERNEL	= -mtune=cortex-a15 -march=armv7-a -marm -mfpu=neon -funsafe-math-optimizations -ftree-vectorize -funroll-loops  
